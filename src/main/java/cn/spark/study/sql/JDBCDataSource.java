...
public class JDBCDataSource {
	...
	public static void main(String[] args) {
		...
		options.put("url", "jdbc:mysql://hadoop-3:3306/testdb");
		...
		StructType strucType = DataTypes.createStructType(structFields);
		
		DataFrame studentsDF = sqlContext.createDataFrame(filteredStudentRowsRDD, strucType);
