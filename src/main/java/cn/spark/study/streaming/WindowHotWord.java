...
public class WindowHotWord {
	...
	public static void main(String[] args) {
		...
		JavaDStream<String> searchWordsDStream = searchLogsDStream.map(
		...
		searchWordCountsDStream.transform(new Function<JavaPairRDD<String,Integer>, JavaRDD<String>>() {

			private static final long serialVersionUID = 1L;

			@Override
			public JavaRDD<String> call(JavaPairRDD<String, Integer> searchWordCountsRDD) throws Exception {
				// 执行搜索词和出现频率的反转
